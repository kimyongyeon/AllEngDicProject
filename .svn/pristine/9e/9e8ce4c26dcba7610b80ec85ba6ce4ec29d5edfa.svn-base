...
public class AllEngDic_Setting extends Activity implements OnClickListener {
	...
	ListView lv;
	TextView tv1, setBt02;
	LinearLayout setHelp, setSound, bt2;
	...
	class WordAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			// ib = (ImageButton)
			// convertView.findViewById(R.id.setting_rowChk01); // 체크박스
			final CheckBox checkbox = (CheckBox) convertView.findViewById(R.id.setting_rowChk01); // 지움
																									// 체크박스
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setBack = (LinearLayout) findViewById(R.id.setBack);
		setHelp = (LinearLayout) findViewById(R.id.setHelp);
		setSound = (LinearLayout) findViewById(R.id.setSound);
		bt2 = (LinearLayout) findViewById(R.id.setBt02);

		bt1.setOnClickListener(this);
		bt2.setOnClickListener(this);

		LinearLayout ll2 = (LinearLayout) findViewById(R.id.setLl02);
		LinearLayout ll3 = (LinearLayout) findViewById(R.id.btn_set_notice);
		...
		((LinearLayout) findViewById(R.id.btn_set_request)).setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(AllEngDic_Setting.this, AllEngDic_Request.class);
	...
	private void emailSend() {
		Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:toyongyeon@gmail.com;kjs2286@gmail.com"));
		startActivity(intent);
	}
	...
	private void sms_textSend(String name) {
		...
		startActivity(Intent.createChooser(it, "How do you want to send message?"));
	}
